...
output "arc_kubernetes_flux_configurations_blob_storage" {
  ...
  value       = { for k, v in azurerm_arc_kubernetes_flux_configuration.arc_kubernetes_flux_configurations : k => v.blob_storage if v.blob_storage != null && length(v.blob_storage) > 0 }
  sensitive   = true
}
output "arc_kubernetes_flux_configurations_bucket" {
  ...
  value       = { for k, v in azurerm_arc_kubernetes_flux_configuration.arc_kubernetes_flux_configurations : k => v.bucket if v.bucket != null && length(v.bucket) > 0 }
  sensitive   = true
}
...
output "arc_kubernetes_flux_configurations_git_repository" {
  ...
  value       = { for k, v in azurerm_arc_kubernetes_flux_configuration.arc_kubernetes_flux_configurations : k => v.git_repository if v.git_repository != null && length(v.git_repository) > 0 }
  sensitive   = true
}
