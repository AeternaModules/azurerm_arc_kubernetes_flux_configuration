output "arc_kubernetes_flux_configurations_id" {
  ...
  value       = { for k, v in azurerm_arc_kubernetes_flux_configuration.arc_kubernetes_flux_configurations : k => v.id if v.id != null && length(v.id) > 0 }
}
output "arc_kubernetes_flux_configurations_blob_storage" {
  ...
  value       = { for k, v in azurerm_arc_kubernetes_flux_configuration.arc_kubernetes_flux_configurations : k => one(v.blob_storage) if v.blob_storage != null && length(v.blob_storage) > 0 }
  sensitive   = true
}
output "arc_kubernetes_flux_configurations_bucket" {
  ...
  value       = { for k, v in azurerm_arc_kubernetes_flux_configuration.arc_kubernetes_flux_configurations : k => one(v.bucket) if v.bucket != null && length(v.bucket) > 0 }
  sensitive   = true
}
output "arc_kubernetes_flux_configurations_cluster_id" {
  ...
  value       = { for k, v in azurerm_arc_kubernetes_flux_configuration.arc_kubernetes_flux_configurations : k => v.cluster_id if v.cluster_id != null && length(v.cluster_id) > 0 }
}
output "arc_kubernetes_flux_configurations_continuous_reconciliation_enabled" {
  ...
  value       = { for k, v in azurerm_arc_kubernetes_flux_configuration.arc_kubernetes_flux_configurations : k => v.continuous_reconciliation_enabled if v.continuous_reconciliation_enabled != null }
}
output "arc_kubernetes_flux_configurations_git_repository" {
  ...
  value       = { for k, v in azurerm_arc_kubernetes_flux_configuration.arc_kubernetes_flux_configurations : k => one(v.git_repository) if v.git_repository != null && length(v.git_repository) > 0 }
  sensitive   = true
}
output "arc_kubernetes_flux_configurations_kustomizations" {
  ...
  value       = { for k, v in azurerm_arc_kubernetes_flux_configuration.arc_kubernetes_flux_configurations : k => v.kustomizations if v.kustomizations != null && length(v.kustomizations) > 0 }
}
output "arc_kubernetes_flux_configurations_name" {
  ...
  value       = { for k, v in azurerm_arc_kubernetes_flux_configuration.arc_kubernetes_flux_configurations : k => v.name if v.name != null && length(v.name) > 0 }
}
output "arc_kubernetes_flux_configurations_namespace" {
  ...
  value       = { for k, v in azurerm_arc_kubernetes_flux_configuration.arc_kubernetes_flux_configurations : k => v.namespace if v.namespace != null && length(v.namespace) > 0 }
}
output "arc_kubernetes_flux_configurations_scope" {
  ...
  value       = { for k, v in azurerm_arc_kubernetes_flux_configuration.arc_kubernetes_flux_configurations : k => v.scope if v.scope != null && length(v.scope) > 0 }
}
